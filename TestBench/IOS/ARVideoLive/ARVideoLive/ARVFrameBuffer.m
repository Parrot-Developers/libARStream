...
- (id)initWithCapacity:(int)capacity
{
    ...
    if (self)
    {
        ...
        {
            [_frames addObject:[[ARVFrame alloc] init]];
        }
        _capacity = capacity;
        _readIndex = 0;
        _writeIndex = 0;
...
- (BOOL)addElement:(ARVFrame *)element
{
    ...
    ARVFrame *localFrame = [_frames objectAtIndex:(_writeIndex % _capacity)];
