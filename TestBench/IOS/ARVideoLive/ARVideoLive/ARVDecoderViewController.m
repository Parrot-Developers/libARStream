...
#else
@property (nonatomic, strong) ARVDisplayRGB *display;
#endif
...
#else
    CGSize resolution = { videoWidth, videoHeight };
    _display = [[ARVDisplayRGB alloc] initWithFrame:frame andResolution:resolution];
