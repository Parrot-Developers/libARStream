...
#define ARSTREAMING_DEFAULT_FILENAME @"ARSLog"
#define ARSTREAMING_DATE_FORMAT @"_yyyyMMdd_HHmmss"
...
- (id)init
{
    ...
    if (self)
    {
        NSString *filename = [NSString stringWithFormat:@"%@/%@%@.log", [self applicationDocumentsDirectory], ARSTREAMING_DEFAULT_FILENAME, [self nowTime:YES]];
...
- (NSString *)nowTime:(BOOL)useDate
{
    ...
    [formatter setDateFormat:ARSTREAMING_DATE_FORMAT];
