 ...
 * Macros
 */
#define ARVIDEO_BUFFERS_DATA_BUFFER_TYPE            (ARNETWORKAL_FRAME_TYPE_DATA_LOW_LATENCY)
#define ARVIDEO_BUFFERS_DATA_BUFFER_SEND_EVERY_MS   (0) // Zero means "send every time we can"
...
#define ARVIDEO_BUFFERS_ACK_BUFFER_TYPE             (ARNETWORKAL_FRAME_TYPE_DATA_LOW_LATENCY)
#define ARVIDEO_BUFFERS_ACK_BUFFER_SEND_EVERY_MS    (0) // Zero means "send every time we can"
#define ARVIDEO_BUFFERS_ACK_BUFFER_NUMBER_OF_CELLS  (1000) // TODO: Change to 1 when mantis 115578 will be fixed
