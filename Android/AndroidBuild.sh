...
CONF_ARGS="--prefix=$PREFIX --with-libARSALInstallDir=$JNIDIR/libARSAL --with-libARNetworkInstallDir=$JNIDIR/libARNetwork --with-libARNetworkALInstallDir=$JNIDIR/libARNetworkAL --host=arm-linux-androideabi --disable-so-version"
